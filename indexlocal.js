...
var capabilities;
fetch(
  "https://192.168.1.67:8443/geoserver/wms?service=WMS&version=1.1.1&request=GetCapabilities"
...
var wmsSource = new ImageWMS({
  url: "https://192.168.1.67:8443/geoserver/wms",
  title: "wmsLayer",
  params: {
...
function tileLayerFactory(site) {
  ...
  return new TileLayer({
    ...
    source: new TileWMS({
      ...
      url: "https://192.168.1.67:8443/geoserver/saige/wms",
      attributions:
...
function orthoLayerFactory(orthoSite) {
  ...
  return new TileLayer({
    ...
    //visible: [title.includes("nov")  ? true : false],
    source: new WMTS({
      url: 'http://192.168.1.67:8443/geoserver/gwc/service/wmts',
      layer: orthoSite,
      attributions:
