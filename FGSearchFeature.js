...
*/
/*
  Added desired behavour by making small change to ol-ext/Search. Added FGSearch
  and FGSearchFeature files to used change. This might be more elegantly done by
  inheriting from SearchFeature and overriding the function. Consider changing.
*/
import ol_ext_inherits from 'ol-ext/util/ext'
import ol_control_Search from './FGSearch'
